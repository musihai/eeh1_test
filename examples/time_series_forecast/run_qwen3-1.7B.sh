...
MAX_RESPONSE_LENGTH="${MAX_RESPONSE_LENGTH:-${RL_MAX_RESPONSE_LENGTH:-2048}}"
...
TEMPERATURE="${TEMPERATURE:-${RL_TEMPERATURE:-1.0}}"
VAL_TEMPERATURE="${VAL_TEMPERATURE:-${RL_VAL_TEMPERATURE:-1.0}}"
