...
export RL_TRAIN_FILES="${RL_TRAIN_FILES:-$PROJECT_DIR/dataset/ett_rl_etth1_paper_aligned_ot_curriculum_same2/train_stage123.jsonl}"
export RL_VAL_FILES="${RL_VAL_FILES:-$PROJECT_DIR/dataset/ett_rl_etth1_paper_aligned_ot_curriculum_same2/val.jsonl}"
export RL_PROJECT_NAME="${RL_PROJECT_NAME:-TimeSeriesForecast}"
export RL_ROLLOUT_TP="${RL_ROLLOUT_TP:-1}"
export RL_ROLLOUT_GPU_MEMORY_UTILIZATION="${RL_ROLLOUT_GPU_MEMORY_UTILIZATION:-0.22}"
...
export RL_TEMPERATURE="${RL_TEMPERATURE:-0.3}"
export RL_VAL_TEMPERATURE="${RL_VAL_TEMPERATURE:-0.1}"
export RL_NNODES="${RL_NNODES:-1}"

export SFT_TRAIN_FILES="${SFT_TRAIN_FILES:-$PROJECT_DIR/dataset/ett_sft_etth1_runtime_ot_teacher200_paper_same2/train.parquet}"
export SFT_VAL_FILES="${SFT_VAL_FILES:-$PROJECT_DIR/dataset/ett_sft_etth1_runtime_ot_teacher200_paper_same2/val.parquet}"
