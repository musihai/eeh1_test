...
export RL_TRAIN_FILES="${RL_TRAIN_FILES:-$PROJECT_DIR/dataset/ett_rl_etth1_paper_aligned_ot_curriculum_same2/train.jsonl}"
...
export RL_TEMPERATURE="${RL_TEMPERATURE:-0.4}"
