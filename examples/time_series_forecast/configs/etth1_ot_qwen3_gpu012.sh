...
export SFT_SAVE_DIR="${SFT_SAVE_DIR:-$PROJECT_DIR/artifacts/checkpoints/sft/time_series_forecast_sft_paper_strict_formal_20260323}"
...
case "$RUN_MODE" in
    smoke)
        ...
        ;;
    train)
        export SFT_EXPERIMENT_NAME="${SFT_EXPERIMENT_NAME:-qwen3-1.7b-etth1-ot-sft-paper-strict-formal-20260323}"
