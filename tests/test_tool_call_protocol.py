...
from recipe.time_series_forecast.tool_call_protocol import extract_tool_calls, load_time_series_chat_template
...
class ToolCallProtocolTests(unittest.TestCase):
    ...
    def test_custom_chat_template_uses_valid_json_example(self) -> None:
        ...
        self.assertIn('{\\"name\\": \\"tool_name\\", \\"arguments\\": {}}', template)
