...
class SingleStepSingleTurnAgentFlow(AgentFlowBase):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentFlowOutput:
        ...
        # Compute reward in run method (using base class method)
        reward_score, reward_extra_info = await self._compute_reward(
        ...
        step = AgentFlowStep(
            ...
            extra_fields={"reward_extra_info": reward_extra_info} if reward_extra_info else {},
        )
